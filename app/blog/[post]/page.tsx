        ...
        <article>
          ...
          >
            ...
            <aside className="flex flex-col lg:max-h-full h-max gap-y-8 sticky top-2 bottom-auto right-0 py-10 lg:px-6 px-0">
              <section className="dark:bg-primary-bg bg-zinc-100 border dark:border-zinc-800 border-zinc-200 rounded-md p-5">
                <h3 className="text-2xl font-semibold tracking-tight">
                  Building something like this?
                </h3>

                <p className="text-sm text-zinc-500 mt-2 leading-relaxed">
                  I help turn ideas into real AI products.
                </p>
                <Link href="/contact">
                  <button className="mt-4 w-full bg-white text-black text-sm font-medium rounded-lg py-2 hover:bg-zinc-200 transition">
                    Let’s ship it →
                  </button>
                </Link>
              </section>
